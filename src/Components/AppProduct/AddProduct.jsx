        ...
        <div>
          ...
          <div className="FormaSend">
            <form>
              ...
              <input type="tel" placeholder="+99894 888 74452" id="phone" required />

              <label htmlFor="email">Email-адрес</label>
              <input type="email" placeholder="ilhomjopiskandarov2006@gmail.com" id="email" required/>

              <label htmlFor="name">Контактный лицо</label>
              <input type="text" placeholder="Зухриддин" id="name" required/>
